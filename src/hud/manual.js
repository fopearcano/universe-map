...
const SECTIONS = [
  ['Four scales', [
    ...
    ['DEEPTIME', 'The far-future universe of the QTR canon (⧗ DEEPTIME or key 4) — the cosmos ~50 billion years on, procedurally generated on the <b>same logarithmic scale and Planck-ΛCDM rules as COSMOS</b> (direction exact, radius log-compressed) but re-grown from those rules rather than the real data, because in 50 Gyr the real cosmos has changed. There is no Sun any more, so a merged <b>home supergalaxy</b> (⌂ Aeon Hearth, the descendant of the Local Group) anchors the origin the way Sol anchors Cosmos. It is <b>much larger and more structured than Cosmos</b> — the expansion has run on, so the map reaches well past the cosmos horizon (×1.85). Built from a real dataset, it threads a vast gravitationally-shaped <b>cosmic web</b> — a spanning skeleton of <b>~5,700 filaments</b> (grown by a minimum-spanning tree over ~1,800 nodes, then cross-linked, walled and frayed with fine <b>tendrils</b> the way real surveys map it) that <b>curve and sag</b> between clusters rather than running straight, and reach nearly to the rim — traced by a dense <b>~360,000-galaxy</b> background field so the web reads clearly — with <b>~5,000 named, navigable anchor galaxies</b> (each carrying a far-future dossier — era on the Φ ladder, its inhabitant species, the drive-class that reaches it; use the navigator&rsquo;s <b>filter box</b> to find one by name) and a full catalogue of <b>~19,000</b> QTR <b>deep-time objects, events & hazards</b>: gold-ringed <b>seam-wells</b> and engineered <b>kindled wells</b>, <b>seam-pearls</b>, cyan <b>information reefs</b>, pulsing <b>beacon cores</b>, violet-ringed <b>Formless mouths</b>, red <b>law-shards</b>, entangled <b>amplitude twins</b>, plus hazard/frontier <b>regions</b> (the Dead-Sea, squalls, the Κ refusal zone) and <b>event</b> markers (crossings, seam-scars, the aeonic edge). Click any of them for its lore, with a ◇ <b>codex</b> link straight to its entry. It is a <b>matrioska</b> (nested) scale: click any galaxy for its facts, then ⛶ <b>enter</b> (or key G) to fly <b>inside its own star field</b> — a "local"-sized database of tens of thousands of stars, generated on demand, with <b>morphology that truly varies</b> (grand-design vs flocculent spirals, ringed discs, edge-on dust lanes, smooth lenticulars, boxy/disky ellipticals with globular sprinkles, diffuse dwarves and tidal-tailed irregulars — each with a bright nucleus, HII knots and an age-tinted palette). Pick stars inside; ↑ overview (or Esc) rises back out. The top-centre navigator lists & filters the anchor galaxies and drives enter / overview — and it is a <b>movable, hideable</b> panel like the rest (drag its crumb bar, or toggle it from the ⧗ Deep-Time button in the top dock). A <b>⟿ Ways of the Deep</b> network (in the LAYERS tab) overlays the far-future travel web — thousands of colour-coded intergalactic routes fanning out from the home supergalaxy in branching trunks (each trunk its own hue) along the cosmic web, browsable and filterable by order (Bridge-roads, Beacon-circuits, Seam-hauls, Reef-runs, Pilgrim-ways, Kindled-lanes, Refusal-patrols, Amplitude-threads); click a way to trace it or ▶ to load it into the NAV COMPUTER. Enter a galaxy and it draws its own interior courier lanes too. The <b>VOYAGES</b> tab charts curated multi-galaxy journeys (The Long Spiral In, The Beacon Circuit, Pilgrimage to the Mouth, The Seam-Well Road, The Refusal March) — click one to load it as a plotted course. <b>Voyages & NavCom work here too</b>: select galaxies and ＋ route them, pick a DRIVE and ENGAGE — the NAV COMPUTER reports honest Deep-Time distances and QTR times (a route waypoint on a galaxy can even descend inside it mid-flight), and Solaris.Ai can drive it — "show me the deep-time universe", "show the deep-time routes", "fly the Beacon Circuit", "take me to Aeon Hearth", "enter Vael Reach".'],
  ]],
  ['Getting around', [
