...
const SECTIONS = [
  ...
  ['Layers & overlays', [
    ...
    ['Procedural fill', 'ON by default — completes the sky into a navigable "known universe" (imagined) so the charted cosmos reads as broadly explored, draped onto a gravity-shaped cosmic web (filaments, walls & voids) that reflects the real data, with a portion spread evenly in depth to fill the gap the real surveys leave between the nearby cloud and the deep shells. Green, or matched to real data; toggle it in Layers.'],
